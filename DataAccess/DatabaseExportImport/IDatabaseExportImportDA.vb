...
Namespace DatabaseExportImport
    Public Interface IDatabaseExportImportDA
        ...
        Function ImportData(ByVal DatabasePath As String, ByVal BranchID As String, ByVal ImportDataType As String) As Boolean
        ...
        Function UpdateIsUploaded(Optional ByVal dt As String = "") As Boolean
        ...
        Function GetToMailCCMail(ByVal TransactionType As String) As ExportDataInfo
        ...
        Function CreateSQliteConnectionString(ByVal FileName As String, ByVal Password As String) As String
    End Interface
End Namespace
