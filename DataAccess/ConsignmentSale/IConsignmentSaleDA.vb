...
Namespace ConsignmentSale
    Public Interface IConsignmentSaleDA
        Function InsertConsignmentSale(ByVal Obj As ConsignmentSaleInfo) As Boolean
        Function UpdateConsignmentSale(ByVal Obj As ConsignmentSaleInfo) As Boolean
        ...
        Function InsertConsignmentSaleItem(ByVal ObjItem As ConsignmentSaleItemInfo) As Boolean
        Function UpdateConsignmentSaleItem(ByVal ObjItem As ConsignmentSaleItemInfo) As Boolean
        Function DeleteConsignmentSaleItem(ByVal ConsignmentSaleItemID As String) As Boolean
