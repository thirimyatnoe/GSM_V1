...
Namespace CompanyProfile
    Public Interface ICompanyProfileDA
        Function InsertCompanyProfile(ByVal obj As CompanyProfileInfo) As Boolean
        Function UpdateCompanyProfile(ByVal obj As CompanyProfileInfo) As Boolean
