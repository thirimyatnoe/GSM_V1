...
Namespace WasteSetup
    Public Interface IWasteSetupDA
        Function InsertWasteSetup(ByVal WasteSetupObj As WasteSetupHeaderInfo) As Boolean

        Function GetWasteSetup() As DataTable
        Function UpdateWasteSetup(ByVal WasteSetupObj As WasteSetupHeaderInfo) As Boolean
