Public Class WholeSaleInvoiceItemInfo
#Region "Private Property"
    Private _WholesaleInvoiceItemID As String
    ...
    Private _ItemDisPercent As Integer
    Private _ItemDisAmount As Integer
...
#Region "Properties "
    Public Property WholesaleInvoiceItemID() As String
        Get
            WholesaleInvoiceItemID = _WholesaleInvoiceItemID
        End Get
        Set(ByVal value As String)
            _WholesaleInvoiceItemID = value
        End Set
    End Property
    ...
    Public Property ItemDisPercent() As Integer
        Get
            ItemDisPercent = _ItemDisPercent
        End Get
        Set(ByVal value As Integer)
            _ItemDisPercent = value
        End Set
    End Property

    Public Property ItemDisAmount() As Integer
        Get
            ItemDisAmount = _ItemDisAmount
        End Get
        Set(ByVal value As Integer)
            _ItemDisAmount = value
        End Set
    End Property
