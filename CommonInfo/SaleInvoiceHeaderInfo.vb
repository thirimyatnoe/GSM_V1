Public Class SaleInvoiceHeaderInfo
#Region "Private Property"
    ...
    Private _EntryAdvanceDate As Date
    Private _AllAdvanceAmount As Integer
...
#Region "Properties "
    ...
    Public Property IsAdvance() As Boolean
        ...
        End Set
    End Property
    Public Property EntryAdvanceDate() As Date
        Get
            EntryAdvanceDate = _EntryAdvanceDate
        End Get
        Set(ByVal value As Date)
            _EntryAdvanceDate = value
        End Set
    End Property
    Public Property AllAdvanceAmount() As Integer
        Get
            AllAdvanceAmount = _AllAdvanceAmount
        End Get
        Set(ByVal value As Integer)
            _AllAdvanceAmount = value
        End Set
    End Property
