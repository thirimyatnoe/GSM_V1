Public Class PurchaseGemsItemInfo
#Region "Private Property"
    Private _PurchaseGemsItemID As String
...
#Region "Properties "
    Public Property PurchaseGemsItemID() As String
        Get
            PurchaseGemsItemID = _PurchaseGemsItemID
        End Get
        Set(ByVal value As String)
            _PurchaseGemsItemID = value
        End Set
    End Property
