Public Class OrderInvoiceDetailGemInfo
#Region "Private Property"
    Private _OrderInvoiceDetailGemsID As String
...
#Region "Properties "
    Public Property OrderInvoiceDetailGemsID() As String
        Get
            OrderInvoiceDetailGemsID = _OrderInvoiceDetailGemsID
        End Get
        Set(ByVal value As String)
            _OrderInvoiceDetailGemsID = value
        End Set
    End Property
