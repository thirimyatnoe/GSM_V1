Public Class PurchaseInvoiceGemsItemInfo
#Region "Private Property"
    Private _PurchaseInvoiceGemsItemID As String
    ...
    Private _FixType As Integer
    Private _Amount As Integer

#End Region

#Region "Properties "
    Public Property PurchaseInvoiceGemsItemID() As String
        Get
            PurchaseInvoiceGemsItemID = _PurchaseInvoiceGemsItemID
        End Get
        Set(ByVal value As String)
            _PurchaseInvoiceGemsItemID = value
        End Set
    End Property
    ...
    Public Property PurchaseRate() As Integer
        ...
        End Set
    End Property
    Public Property FixType() As Integer
        Get
            FixType = _FixType
        End Get
        Set(ByVal value As Integer)
