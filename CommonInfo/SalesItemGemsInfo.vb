Public Class SalesItemGemsInfo
#Region "Private Property"
    Private _ForSaleGemsItemID As String
    ...
    Private _SaleByDefinePrice As Boolean


#End Region

#Region "Properties "
    Public Property ForSaleGemsItemID() As String
        Get
            ForSaleGemsItemID = _ForSaleGemsItemID
        End Get
        Set(ByVal value As String)
            _ForSaleGemsItemID = value
        End Set
    End Property
    ...
    Public Property GemsRemark() As String
        ...
        End Set
    End Property
    Public Property SaleByDefinePrice() As Boolean
        Get
            SaleByDefinePrice = _SaleByDefinePrice
        End Get
        Set(ByVal value As Boolean)
            _SaleByDefinePrice = value
        End Set
    End Property
