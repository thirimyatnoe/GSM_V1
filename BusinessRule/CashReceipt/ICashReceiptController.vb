...
Namespace CashReceipt
    Public Interface ICashReceiptController
        ...
        Function GetSaleInvoiceVolumeCashReceipt(ByVal IsCash As Boolean) As DataTable
        ...
        Function SaveCashReceipt(ByVal VoucherNo As String, ByVal Type As String, ByVal dt As DataTable) As Boolean
