...
Public Class frm_ImportDatabaseForBranch
    ...
    Private Sub btnExport_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        If InStr(strFileName, "Divide", CompareMethod.Text) > 0 Then
            ...
            If objDataExportImport.ImportDatabaseFromHO(txtPath.Text.Trim, IsStock, StockStatus, IsDivided, ScriptFileName) = False Then
        ...
        ElseIf InStr(strFileName, "Stock", CompareMethod.Text) > 0 Then
            ...
            '    IsNewStock = False
            'End If
            If optNewStock.Checked = True Then
                StockStatus = "New"
                'ElseIf optEditStock.Checked = True Then
                '    StockStatus = "Update"
            Else
                StockStatus = "Update"
            End If
