...
Public Class frm_CustomerShow
    Implements IFormProcess
#Region " Private Properties "
    Public _CustomerID As String
    Public _CustomerCode As String
    ...
    Public _IsUpdate As Boolean = False
...
#Region " IFormProcess "
    ...
    '        dt = _CustomerController.GetCustomerDataByCustomerName(objCustomerInfo.CustomerName, objCustomerInfo.CustomerID)
    '        If dt.Rows.Count = 0 Then
    '            _CustomerID = _CustomerController.SaveCustomer(objCustomerInfo)
    '            Me.Close()
    '        Else
    '            MsgBox("Customer's Name  is duplicated! Save with another one!", MsgBoxStyle.Information, "Data Duplicated !")
    '        End If
    '    Else
    '        Dim dtCustomer As New DataTable
    '        dtCustomer = _CustomerController.GetCustomerDataByCustomerName(objCustomerInfo.CustomerName)
...
#End Region
    ...
    Private Sub frm_CustomerShow_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Function Get_Data() As CommonInfo.CustomerInfo
        ...
        With objCustomerInfo
            ...
            .DOB = dtpDOB.Value
            .NRC = IIf(txtNRC.Text = "", "-", txtNRC.Text)
