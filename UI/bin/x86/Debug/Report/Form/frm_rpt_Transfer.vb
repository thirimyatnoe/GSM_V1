...
Public Class frm_rpt_Transfer
    Private ReportDA As Transfer.ITransferController = Factory.Instance.CreateTransferController
    Private LDReportDA As TransferDiamond.ITransferDiamondController = Factory.Instance.CreateTransferDiamondController
...
#End Region
    ...
    Private Sub btnPreview_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPreview.Click
        ...
        If chkLooseDiamond.Checked Then
            dt = LDReportDA.GetBranchTransferReport(dtpFromDate.Value.Date, dtpToDate.Value.Date, GetFilterString)

            rptViewer.Reset()
            rptViewer.LocalReport.ReportEmbeddedResource = IIf(radSummary.Checked, "UI.rpt_TransferDiamond_Summary.rdlc", "UI.rpt_TransferDiamond_Detail.rdlc")
            rptViewer.LocalReport.DataSources.Clear()
            rptViewer.LocalReport.DataSources.Add(New ReportDataSource("dsTransfer_TransferData", dt))
        Else
            dt = ReportDA.GetBranchTransferReport(dtpFromDate.Value.Date, dtpToDate.Value.Date, GetFilterString)

           
            rptViewer.Reset()
            rptViewer.LocalReport.ReportEmbeddedResource = IIf(radSummary.Checked, "UI.rpt_Transfer_Summary.rdlc", "UI.rpt_Transfer_Detail.rdlc")
            rptViewer.LocalReport.DataSources.Clear()
            rptViewer.LocalReport.DataSources.Add(New ReportDataSource("dsTransfer_TransferData", dt))
        End If
    ...
    Private Function GetFilterString() As String
        ...
        If (chkBranch.Checked) Then
            GetFilterString += " And H.LocationID = '" & cboBranch.SelectedValue & "'"
        End If
    ...
    Private Sub chkLooseDiamond_CheckedChanged(sender As Object, e As EventArgs) Handles chkLooseDiamond.CheckedChanged
        If chkLooseDiamond.Checked = True Then
